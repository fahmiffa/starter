            ...
            <table class="min-w-full bg-white border border-gray-200 text-sm">
                <thead>
                    <tr class="bg-gray-100 text-left">
                        ...
                        <th @click="sortBy('email')" class="cursor-pointer px-4 py-2">PCS</th>
                        <th @click="sortBy('age')" class="cursor-pointer px-4 py-2">Action</th>
                    </tr>
                </thead>
                <tbody>
                    <template x-for="(row, index) in paginatedData()" :key="row.id">
                        <tr class="border-t border-gray-400">
                            ...
                            <td class="px-4 py-2 flex items-center gap-1">
                                <a :href="`{{ url('dashboard/unit') }}/${row.id}/edit`"
                                ...
                                <form :action="`{{ url('dashboard/unit') }}/${row.id}`" method="POST"
